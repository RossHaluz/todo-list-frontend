...
const Sidebar = () => {
  ...
  <div className={`w-[225px] md:w-[260px] overflow-auto z-10 ${isOpenMenu ? 'flex fixed top-0 left-0' : "hidden"} lg:flex fixed h-screen ${theme === 'dark' && 'bg-[#121212]'} ${theme === 'light' && 'bg-[#fff]'} ${theme === 'violet' && 'bg-[#5255BC]'} text-white flex flex-col`} >
